/**
 * TrialSage™ CommonJS Server Implementation
 * Production-ready server with CommonJS compatibility
 */
...
function startServer() {
  ...
  server.listen(PORT, '0.0.0.0', () => {
    logger.info(`TrialSage CommonJS server running on http://localhost:${PORT}`);
  });
