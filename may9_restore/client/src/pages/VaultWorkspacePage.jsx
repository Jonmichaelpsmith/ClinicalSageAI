...
export default function VaultLandingPageWithAI() {
  ...
  const [messages, setMessages] = useState([{ role: 'assistant', content: '👋 Hello! Welcome to TrialSage Vault™ — your intelligent clinical document solution. How can I help you today?' }]);
  ...
  return (
    <div className="relative bg-gradient-to-b from-blue-50 to-white min-h-screen p-8">
      ...
      <div className="fixed bottom-6 right-6">
        {!showAssistant ? (
          <Button variant="default" onClick={() => setShowAssistant(true)}>💬 Chat with Vault AI</Button>
        ) : (
