...
// Configuration
const BATCH_SIZE = 200; // Number of trials per batch - process 1000 at a time
...
`);
    ...
    if (remainingToImport <= 0) {
      console.log(`Target of ${TARGET_COUNT} Health Canada trials already reached or exceeded (${currentHCCount}/${TARGET_COUNT}). No import needed.`);
      await pool.end();
      return;
    }
