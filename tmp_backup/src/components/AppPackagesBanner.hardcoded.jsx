          ...
          <div className="flex justify-center mb-4 px-6">
            <div className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-5 w-full max-w-6xl" style={{ gap: '1px' }}>
              ...
              <Link to="/ind-solution" className="block">
                <div className="bg-purple-600 hover:brightness-110 transition-all duration-200 border-t-0 border-l-0 border-r-0 border-b-[1px] border-white/10 h-full flex flex-col justify-between" style={{ padding: '10px', minHeight: '82px' }}>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      <div className="bg-white/10 rounded-sm flex items-center justify-center" style={{ width: '18px', height: '18px' }}>
                        <FileArchive size={10} />
                      </div>
                      <h3 className="text-xs font-semibold text-white ml-1.5 tracking-tight">Accelerate IND</h3>
                    </div>
                  </div>
                  <div>
                    <p className="text-[11px] leading-tight text-white/75 mt-1.5">Your AI partner for IND success</p>
              ...
              <Link to="/csr-intelligence" className="block">
                <div className="bg-emerald-600 hover:brightness-110 transition-all duration-200 border-t-0 border-l-0 border-r-0 border-b-[1px] border-white/10 h-full flex flex-col justify-between" style={{ padding: '10px', minHeight: '82px' }}>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      <div className="bg-white/10 rounded-sm flex items-center justify-center" style={{ width: '18px', height: '18px' }}>
                        <Database size={10} />
                      </div>
                      <h3 className="text-xs font-semibold text-white ml-1.5 tracking-tight">CSR Intelligence</h3>
                    </div>
                  </div>
                  <div>
                    <p className="text-[11px] leading-tight text-white/75 mt-1.5">CSR analysis and optimization</p>
                    <div className="flex justify-end mt-1">
                      <ChevronRight size={9} className="text-white/60" />
                    </div>
                  </div>
              ...
              <Link to="/cer-generator" className="block">
                <div className="bg-rose-600 hover:brightness-110 transition-all duration-200 border-t-0 border-l-0 border-r-0 border-b-[1px] border-white/10 h-full flex flex-col justify-between" style={{ padding: '10px', minHeight: '82px' }}>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      <div className="bg-white/10 rounded-sm flex items-center justify-center" style={{ width: '18px', height: '18px' }}>
                        <FileArchive size={10} />
                      </div>
                      <h3 className="text-xs font-semibold text-white ml-1.5 tracking-tight">CER Module</h3>
                    </div>
                  </div>
                  <div>
                    <p className="text-[11px] leading-tight text-white/75 mt-1.5">Clinical evaluation reports</p>
                    <div className="flex justify-end mt-1">
                      <ChevronRight size={9} className="text-white/60" />
                    </div>
                  </div>
              ...
              <Link to="/study-protocol-builder" className="block">
                <div className="bg-blue-600 hover:brightness-110 transition-all duration-200 border-t-0 border-l-0 border-r-0 border-b-[1px] border-white/10 h-full flex flex-col justify-between" style={{ padding: '10px', minHeight: '82px' }}>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      <div className="bg-white/10 rounded-sm flex items-center justify-center" style={{ width: '18px', height: '18px' }}>
                        <Beaker size={10} />
                      </div>
                      <h3 className="text-xs font-semibold text-white ml-1.5 tracking-tight">Study & Protocol</h3>
                    </div>
                  </div>
                  <div>
                    <p className="text-[11px] leading-tight text-white/75 mt-1.5">Statistical model-driven design</p>
                    <div className="flex justify-end mt-1">
                      <ChevronRight size={9} className="text-white/60" />
                    </div>
                  </div>
              ...
              <Link to="/usecase-library" className="block">
                <div className="bg-teal-600 hover:brightness-110 transition-all duration-200 border-t-0 border-l-0 border-r-0 border-b-[1px] border-white/10 h-full flex flex-col justify-between" style={{ padding: '10px', minHeight: '82px' }}>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      <div className="bg-white/10 rounded-sm flex items-center justify-center" style={{ width: '18px', height: '18px' }}>
                        <Database size={10} />
                      </div>
                      <h3 className="text-xs font-semibold text-white ml-1.5 tracking-tight">Use Case Library</h3>
                    </div>
                  </div>
                  <div>
                    <p className="text-[11px] leading-tight text-white/75 mt-1.5">Regulatory case studies & templates</p>
                    <div className="flex justify-end mt-1">
                      <ChevronRight size={9} className="text-white/60" />
                    </div>
                  </div>
          ...
          <div className="flex justify-center px-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 w-full max-w-6xl" style={{ gap: '1px' }}>
              ...
              <Link to="/client-portal" className="block">
                <div className="bg-red-600 hover:brightness-110 transition-all duration-200 border-t-0 border-l-0 border-r-0 border-b-[1px] border-white/10 h-full flex flex-col justify-between" style={{ padding: '10px', minHeight: '82px' }}>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      <div className="bg-white/10 rounded-sm flex items-center justify-center" style={{ width: '18px', height: '18px' }}>
                        <FileArchive size={10} />
                      </div>
                      <h3 className="text-xs font-semibold text-white ml-1.5 tracking-tight">Client Access</h3>
                    </div>
                  </div>
                  <div>
                    <p className="text-[11px] leading-tight text-white/75 mt-1.5">Secure portal login</p>
                    <div className="flex justify-end mt-1">
                      <ChevronRight size={9} className="text-white/60" />
                    </div>
                  </div>
              ...
              <Link to="/ai-copilot" className="block">
                <div className="bg-violet-600 hover:brightness-110 transition-all duration-200 border-t-0 border-l-0 border-r-0 border-b-[1px] border-white/10 h-full flex flex-col justify-between" style={{ padding: '10px', minHeight: '82px' }}>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      <div className="bg-white/10 rounded-sm flex items-center justify-center" style={{ width: '18px', height: '18px' }}>
                        <Globe size={10} />
                      </div>
                      <h3 className="text-xs font-semibold text-white ml-1.5 tracking-tight">AI Co-pilot</h3>
                    </div>
                  </div>
                  <div>
                    <p className="text-[11px] leading-tight text-white/75 mt-1.5">Advanced AI assistance</p>
                    <div className="flex justify-end mt-1">
                      <ChevronRight size={9} className="text-white/60" />
                    </div>
                  </div>
                ...
                <div className="bg-purple-600 hover:brightness-110 transition-all duration-200 border-t-0 border-l-0 border-r-0 border-b-[1px] border-white/10 h-full flex flex-col justify-between" style={{ padding: '10px', minHeight: '82px' }}>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      ...
                      <h3 className="text-xs font-semibold text-white ml-1.5 tracking-tight">SmartDocs Generator™</h3>
                    </div>
                  </div>
                  <div>
                    <p className="text-[11px] leading-tight text-white/75 mt-1.5">CERs, protocols, summaries—drafted in hours, not weeks</p>
                    <div className="flex justify-end mt-1">
                      <ChevronRight size={9} className="text-white/60" />
                    </div>
                  </div>
              ...
              <Link to="/insight-vault" className="block">
                <div className="bg-gray-700 hover:brightness-110 transition-all duration-200 border-t-0 border-l-0 border-r-0 border-b-[1px] border-white/10 h-full flex flex-col justify-between" style={{ padding: '10px', minHeight: '82px' }}>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      <div className="bg-white/10 rounded-sm flex items-center justify-center" style={{ width: '18px', height: '18px' }}>
                        <Database size={10} />
                      </div>
                      <h3 className="text-xs font-semibold text-white ml-1.5 tracking-tight">InsightVault™</h3>
                    </div>
                  </div>
                  <div>
                    <p className="text-[11px] leading-tight text-white/75 mt-1.5">A DMS that actually understands your trial</p>
                    <div className="flex justify-end mt-1">
                      <ChevronRight size={9} className="text-white/60" />
                    </div>
                  </div>
