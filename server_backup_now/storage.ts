...
export interface IStorage {
  ...
  updateProject(id: number, projectData: Partial<schema.InsertProject>): Promise<schema.Project | undefined>;
  ...
  updateProjectModule(id: number, moduleData: Partial<schema.InsertProjectModule>): Promise<schema.ProjectModule | undefined>;
  ...
  getProjectWorkflowStages(projectId: number, options?: { 
    includeWithTasks?: boolean;
    orderBy?: string;
  }): Promise<schema.ProjectWorkflowStage[]>;
  createProjectWorkflowStage(stage: schema.InsertProjectWorkflowStage): Promise<schema.ProjectWorkflowStage>;
  updateProjectWorkflowStage(id: number, stageData: Partial<schema.InsertProjectWorkflowStage>): Promise<schema.ProjectWorkflowStage | undefined>;
  ...
  updateProjectTask(id: number, taskData: Partial<schema.InsertProjectTask>): Promise<schema.ProjectTask | undefined>;
  ...
  updateProjectTemplate(id: number, templateData: Partial<schema.InsertProjectTemplate>): Promise<schema.ProjectTemplate | undefined>;
  deleteProjectTemplate(id: number): Promise<boolean>;
  createProjectFromTemplate(templateId: number, projectData: Partial<schema.InsertProject>): Promise<schema.Project>;
