#!/usr/bin/env python3
"""
Train the trial success prediction model using RandomForestClassifier
"""
import pandas as pd
import os
import pickle
...
print("Training RandomForest model for trial success prediction...")

# Load the dataset
df = pd.read_csv("data/csr_dataset_new.csv")
print(f"Total records in dataset: {len(df)}")

# Drop rows missing essential fields
df = df.dropna(subset=["sample_size", "duration_weeks", "dropout_rate", "success"])
print(f"Records with complete required fields: {len(df)}")
...
print("\nSample Predictions:")
sample_data = [
    {"sample_size": 250, "duration_weeks": 24, "dropout_rate": 0.18, "desc": "Obesity Phase 2 trial"},
    {"sample_size": 450, "duration_weeks": 48, "dropout_rate": 0.10, "desc": "Large long-term trial"},
    {"sample_size": 150, "duration_weeks": 12, "dropout_rate": 0.25, "desc": "Small short-term trial"}
]
