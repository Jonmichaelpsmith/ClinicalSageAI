...
import { Upload, FileCheck, AlertCircle, Book } from 'lucide-react';
  ...
  return (
    <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
      ...
      <p className="text-sm text-gray-600 mb-4">
        Upload all versions of investigator brochures (IBs) used during clinical development, including any updates or amendments distributed to investigators.
      </p>
      ...
      <button
        ...
        `}
      >
        {uploading ? 'Uploading...' : 'Upload IB Documents'}
      </button>
      
      <div className="mt-3 text-xs text-gray-500">
        <p>Expected documents: Latest IB version, Previous IB versions used during clinical development, Tracked changes documents showing IB updates</p>
      </div>
    </div>
  );
}