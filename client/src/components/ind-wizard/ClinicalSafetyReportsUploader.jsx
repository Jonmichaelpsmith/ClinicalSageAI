...
import { Upload, FileCheck, AlertCircle, ShieldAlert } from 'lucide-react';
  ...
  return (
    <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
      ...
      <p className="text-sm text-gray-600 mb-4">
        Upload all safety-related documents including Development Safety Update Reports (DSURs), safety narratives for serious adverse events, and periodic safety reports required by regulatory agencies.
      </p>
      ...
      <button
        ...
        `}
      >
        {uploading ? 'Uploading...' : 'Upload Safety Reports'}
      </button>
      
      <div className="mt-3 text-xs text-gray-500">
        <p>Expected documents: DSURs, Individual Case Safety Reports (ICSRs), Safety narrative summaries, Annual safety reports</p>
      </div>
    </div>
  );
}