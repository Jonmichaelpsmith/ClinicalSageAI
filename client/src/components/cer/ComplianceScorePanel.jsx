          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription className="mt-1">
                Analyze your clinical evaluation report against EU MDR, FDA, and ISO 14155 standards
              </CardDescription>
            </div>
            <button
              onClick={runComplianceAnalysis}
              disabled={analyzing || sections.length === 0}
              className="flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md disabled:bg-blue-300 disabled:cursor-not-allowed shadow-sm transition-colors"
            >
              {analyzing ? (
                <>
