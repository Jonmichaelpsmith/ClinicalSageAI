                  ...
                  <div className="bg-slate-50 p-4 rounded-md border border-slate-200 mt-4">
                    ...
                    {loadingCompliance ? (
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground mt-1">
                            {complianceData.progressSummary.steps.completed} of {complianceData.progressSummary.steps.total} implementation steps completed
                          </p>
                        </div>
                        ...
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground mt-1">
                            {complianceData.progressSummary.validationRules.implemented} of {complianceData.progressSummary.validationRules.total} validation rules implemented
                          </p>
                        </div>
                      ...
                      <div className="text-center py-4">
                        ...
                        <Button variant="ghost" size="sm" className="mt-2" onClick={fetchComplianceStatus}>
