      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {solutions.map(({ title, description, icon: Icon }) => (
          ...
          >
            ...
            <div
              className={clsx(
                'absolute inset-0 bg-gradient-to-t from-green-400 to-blue-500 opacity-0 group-hover:opacity-95 transition-opacity flex items-center justify-center p-6 text-center'
              )}
            >
