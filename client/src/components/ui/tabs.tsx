...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-center rounded-xl bg-gray-100/70 backdrop-blur-lg p-1.5 text-muted-foreground shadow-sm border border-gray-100/50",
      className
    )}
    {...props}
  />
