      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 text-gray-800">
        <main className="max-w-6xl mx-auto py-24 px-6 text-center">
          ...
          <div className="flex justify-center space-x-6 mb-12">
            <Link href="/module32">
              <a className="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-8 py-3 rounded-lg shadow-lg flex items-center space-x-2">
                <Sparkles className="w-5 h-5" />
                <span>Start Generating</span>
              </a>
            </Link>
            <Link href="/versions">
              <a className="bg-white hover:bg-gray-100 border border-blue-300 text-blue-800 font-medium px-8 py-3 rounded-lg shadow flex items-center space-x-2">
