...
const SubmissionStorylineDemoPage = () => {
  ...
  return (
    <Layout>
      <div className="container px-4 sm:px-6 py-4 sm:py-6 max-w-full">
        <h1 className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6">Submission Progress Storyline</h1>
        
        {/* Mobile-specific top controls for easier access */}
        {isMobile && (
          <div className="mb-4 bg-white rounded-lg border p-3 shadow-sm">
            <div className="flex flex-wrap gap-2">
              ...
              <div className="w-full flex items-center gap-2">
                <span className="text-xs text-gray-500 whitespace-nowrap">Progress: {progress}%</span>
                <Slider 
                  value={[progress]} 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 mb-6">
          {!isMobile && (
            <Card>
              <CardHeader className="p-4">
                <CardTitle className="text-lg">Submission Configuration</CardTitle>
                <CardDescription>
          ...
          <Card className={isMobile ? "col-span-1" : "lg:col-span-2"}>
            <CardHeader className="p-4">
              <CardTitle className="text-lg">Storyline Preview</CardTitle>
              <CardDescription>
            ...
            <CardContent className="p-4 pt-0">
              <Tabs defaultValue="storyline">
                ...
                <TabsContent value="storyline" className="min-h-[120px] sm:h-[200px] flex items-center justify-center">
                ...
                <TabsContent value="about" className="space-y-2 sm:space-y-4">
                  <h3 className="text-base sm:text-lg font-medium">About Storyline Feature</h3>
                  <p className="text-sm">
