        ...
        <div className="container px-4 md:px-6 py-8 md:py-10 lg:py-12">
          <div className="flex flex-col items-center justify-center space-y-3 text-center">
            <div className="space-y-2">
              ...
              <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                Our platform turns publicly available Clinical Study Reports into valuable, structured intelligence for your biotech.
              </p>
            </div>
          </div>
          <div className="mx-auto grid max-w-5xl grid-cols-1 gap-5 py-6 md:grid-cols-2 lg:grid-cols-3">
            <div className="flex flex-col items-center space-y-4 rounded-lg border p-6 shadow-sm">
              ...
              <h3 className="text-xl font-bold">Structured Extraction</h3>
              <p className="text-center text-gray-500 dark:text-gray-400">
                Extract endpoints, populations, outcomes, and safety profiles automatically from CSR PDFs
              </p>
            </div>
            <div className="flex flex-col items-center space-y-4 rounded-lg border p-6 shadow-sm">
              <div className="rounded-full border p-3">
              ...
              <h3 className="text-xl font-bold">AI Protocol Generator</h3>
              <p className="text-center text-gray-500 dark:text-gray-400">
                Generate optimized protocol drafts based on similar historical trials
              </p>
            </div>
            <div className="flex flex-col items-center space-y-4 rounded-lg border p-6 shadow-sm">
              <div className="rounded-full border p-3">
              ...
              <h3 className="text-xl font-bold">Competitive Benchmarking</h3>
              <p className="text-center text-gray-500 dark:text-gray-400">
                Compare your trial design to competitors and identify differentiation opportunities
              </p>
            </div>
            <div className="flex flex-col items-center space-y-4 rounded-lg border p-6 shadow-sm">
              <div className="rounded-full border p-3">
              ...
              <h3 className="text-xl font-bold">Study Design Agent</h3>
              <p className="text-center text-gray-500 dark:text-gray-400">
                Get expert advice from our AI agent trained on patterns from successful CSRs
              </p>
            </div>
            <div className="flex flex-col items-center space-y-4 rounded-lg border p-6 shadow-sm">
              <div className="rounded-full border p-3">
              ...
              <h3 className="text-xl font-bold">Statistical Modeling</h3>
              <p className="text-center text-gray-500 dark:text-gray-400">
                Forecast trial success, identify risk factors, and simulate virtual trials
              </p>
            </div>
            <div className="flex flex-col items-center space-y-4 rounded-lg border p-6 shadow-sm">
              <div className="rounded-full border p-3">
              ...
              <h3 className="text-xl font-bold">Clean UI & Search</h3>
              <p className="text-center text-gray-500 dark:text-gray-400">
                Explore, search, and filter CSR data through an intuitive interface
              </p>
            </div>
          </div>
        </div>
