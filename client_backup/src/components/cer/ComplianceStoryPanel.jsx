...
const ComplianceStoryPanel = ({
  ...
  const expertTips = [
    ...
    },
    {
      ...
      content: "For equivalence claims, you must demonstrate technical, biological, and clinical equivalence. A simple statement declaring equivalence is not sufficient—you need a detailed comparative analysis based on the device's characteristics.",
      icon: <Lightbulb />,
      areaId: "dataCollection"
    },
    {
