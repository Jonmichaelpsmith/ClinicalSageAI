      ...
      <section className="bg-gradient-to-r from-blue-50 to-indigo-50 py-16">
        <Container className="text-center px-6">
          ...
          <p className="text-xl text-gray-700 max-w-4xl mx-auto mb-8">
            ...
            regulatory development that don't need to be manual anymore—and enhances the parts that do, 
                ...
                <div className="col-span-2 p-8">
                  ...
                  <div className="mt-6 border-t border-gray-100 pt-6">
                    ...
                    <blockquote className="text-gray-700 italic">
                      "We completed our IND in under 5 months using TrialSage—with a team half the size we budgeted for. The automated validation alone saved us weeks of review time."
                    </blockquote>
                    <div className="mt-2 text-sm text-gray-600">— VP Regulatory Affairs, Emerging Biotech</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><Link to="/ind-architect">IND Architect™</Link></li>
                <li><Link to="/csr-intelligence">CSR Oracle™</Link></li>
                <li><Link to="/solutions">SmartDocs™</Link></li>
                <li><Link to="/solutions">InsightVault™</Link></li>
              </ul>
            </div>
            <div>
