...
const debugUtils = {
  ...
  inspectUI: function() {
    ...
    console.log('Tab Buttons:', tabButtons.length ? `✅ Found ${tabButtons.length} tabs` : '❌ No tabs found');
  ...
  find510kComponents: function() {
    ...
    componentNames.forEach(name => {
      ...
      console.log(`${name}:`, elements.length ? `✅ Found ${elements.length} instances` : '❌ Not found');
    });
  ...
  checkErrorHandling: function() {
    ...
    console.log('Global error listeners:', errorListeners ? `✅ Found ${errorListeners.length} listeners` : '❌ No listeners found');
    ...
    console.log('Unhandled rejection listeners:', rejectionListeners ? `✅ Found ${rejectionListeners.length} listeners` : '❌ No listeners found');
